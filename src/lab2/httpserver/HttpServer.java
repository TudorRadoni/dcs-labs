...
public class HttpServer extends Thread {
	...
	private final String iniContext = "C:\\Stuff\\Projects\\Java\\_university\\dcs-labs\\src\\lab2\\httpserver\\";
...
class ProcesRequest extends Thread {
	...
	private byte[] readFile(String fileN) throws Exception {
		...
		if (!f.canRead())
			throw new Exception("Fisierul " + fileN + " nu poate fi citit");
